...
const spend_1 = require("../../model/spend");
class SpendController {
    getAllSpends(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (type) {
                    whereConditions.spendingType = type;
                }
                if (endDate !== "") {
                ...
                const spends = yield spend_1.Spend.findAll({
...
exports.default = new SpendController;
