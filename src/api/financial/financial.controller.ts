...
import financialService from "./financial.service"; // Pastikan path ini benar

class FinancialController {

    // =============================================
    // =========== KONTROLER UNTUK EQUITY ==========
    // =============================================

    public async createEquity(req: Request, res: Response, next: NextFunction) {
        try {
            // Kita akan menggunakan (req as any) untuk mengakses req.user tanpa interface
